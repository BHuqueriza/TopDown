...
internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor
{
    ...
    private const string company1 = "Deep Sprawl";
    private const string websiteUrl1 = " - http://deepsprawl.com";
    ...
    public static void OnWillCreateAsset(string path)
    {
        ...
        file = file.Replace("#DEVELOPERNAME#", "Brian H - deepsprawl@gmail.com");
